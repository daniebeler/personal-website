...
<head>
    <title>MineBoy - Daniel Hiebeler</title>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <section class="section-header row align-items-center justify-content-center">
            <div class="container align-items-center">
                ...
                <div class="align-items-center justify-content-center row d-flex">
                    <button
                        onclick="location.href='https://play.google.com/store/apps/details?id=com.daniebeler.MineBoy';"
        ...
        <section class="align-items-center section-desc row">
            <div class="container justify-content-center">
                <p>
                    Imagine you are a poor mine worker and you are trapped in a tunnel. Now you have to find an exit as
                    soon as possible!
                </p>
            </div>
        </section>
