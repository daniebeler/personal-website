...
<head>
    <title>Speed Clicker - Daniel Hiebeler</title>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <section class="section-header row align-items-center justify-content-center">
            <div class="container align-items-center">
                ...
                <div class="align-items-center justify-content-center row d-flex">
                    <button
                        onclick="location.href='https://play.google.com/store/apps/details?id=com.daniebeler.speed_clicker';"
        ...
        <section class="align-items-center section-desc row">
            <div class="container justify-content-center">
                <p>
                    How many clicks can you do in 10 Seconds? Challenge yourself and your friends to see who has the
                    highest CPS.
                </p>
            </div>
        </section>
        ...
        <section class="section-pictures row">
            <div class="container">
                <div class="row">
                    <div class="col-6 col-xs-12 col-md-7 d-flex justify-content-center align-items-center">
                        <div class="">
                            <p>
                                Listen to the awesome Soundtrack developed by Luca Kessler.
                            </p>
                        </div>
                    </div>
