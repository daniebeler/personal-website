<nav class="navbar fixed-top navbar-holder">
    ...
    <div class="container" style="z-index: 500;">
        <div class="row d-flex flex-grow-1 justify-content-between">
            <div class="col">

            </div>

            <div class="col d-flex justify-content-center">
                <a href="https://daniebeler.com" class="navbar-brand icon-header">Daniel Hiebeler</a>
            </div>

            <div class="col d-flex justify-content-end">
                <button style="z-index: 1030; outline:none;" onclick="toggleNav()" class="nav-toggler" type="button">
    ...
    $(document).ready(function() {
        ...
        $(window).scroll(function() {
            if ($(window).scrollTop() > 1) {
                $('.navbar-holder').addClass('scrolled-navbar');
                ...
                $('.navbar-holder').removeClass('scrolled-navbar');
